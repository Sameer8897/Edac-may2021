...
update p 
    ...
    where P_no='13';
update p
set P_no='p1' where P_no=11;
update p
set P_no='p2' where Pname='Ppro';
update p
set P_no='p3' where Pname='qpro';
create table j(
J_No char(4),
J_Name varchar(10),
city varchar(20));
...
insert into spj values('1001','11','21','100'),
					  ('1002','12','31','200'),
                      ('1003','13','41','300');
update spj 
set Pno='p1' where Sno='1001';
update spj 
set Pno='p2' where Sno='1002';
update spj 
set Pno='p3' where Sno='1003';
select * from spj;
...
select sname from s
	where soundex(sname)=soundex('maheendra');
